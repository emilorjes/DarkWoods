...
namespace DarkWoods.Monster
{
    ...
    {
        public Deathrunner(string monsterName, string monsterAtkkName, int monsterHp, int monsterMaxHp, int monsterLevel, int monsterExp, int monsterAtkDmg)
        {
        ...
        public static Deathrunner deathrunner = new Deathrunner("Deathrunner", "Souldestroyer", 100, 100, 1, 100, 25);
